...
func ImNodesEditorContextGetPanning() cimgui.Vec2 {
...
func ImNodesEditorContextResetPanning(pos cimgui.Vec2) {
...
func ImNodesGetNodeDimensions(id int32) cimgui.Vec2 {
	pOut := new(cimgui.Vec2)
	pOutArg, pOutFin := wrap[C.ImVec2, *Vec2](pOut)
...
func ImNodesGetNodeEditorSpacePos(node_id int32) cimgui.Vec2 {
	pOut := new(cimgui.Vec2)
	pOutArg, pOutFin := wrap[C.ImVec2, *Vec2](pOut)
...
func ImNodesGetNodeGridSpacePos(node_id int32) cimgui.Vec2 {
	pOut := new(cimgui.Vec2)
	pOutArg, pOutFin := wrap[C.ImVec2, *Vec2](pOut)
...
func ImNodesGetNodeScreenSpacePos(node_id int32) cimgui.Vec2 {
	pOut := new(cimgui.Vec2)
	pOutArg, pOutFin := wrap[C.ImVec2, *Vec2](pOut)
...
func ImNodesGetSelectedLinks(link_ids *int32) {
	link_idsArg, link_idsFin := typewrapper.WrapNumberPtr[C.int, int32](link_ids)
...
func ImNodesGetSelectedNodes(node_ids *int32) {
	node_idsArg, node_idsFin := typewrapper.WrapNumberPtr[C.int, int32](node_ids)
...
func ImNodesIsAnyAttributeActiveV(attribute_id *int32) bool {
	attribute_idArg, attribute_idFin := typewrapper.WrapNumberPtr[C.int, int32](attribute_id)
...
func ImNodesIsLinkCreatedBoolPtrV(started_at_attribute_id *int32, ended_at_attribute_id *int32, created_from_snap *bool) bool {
	started_at_attribute_idArg, started_at_attribute_idFin := typewrapper.WrapNumberPtr[C.int, int32](started_at_attribute_id)
	ended_at_attribute_idArg, ended_at_attribute_idFin := typewrapper.WrapNumberPtr[C.int, int32](ended_at_attribute_id)
	created_from_snapArg, created_from_snapFin := typewrapper.WrapBool[C.bool](created_from_snap)
...
func ImNodesIsLinkCreatedIntPtrV(started_at_node_id *int32, started_at_attribute_id *int32, ended_at_node_id *int32, ended_at_attribute_id *int32, created_from_snap *bool) bool {
	started_at_node_idArg, started_at_node_idFin := typewrapper.WrapNumberPtr[C.int, int32](started_at_node_id)
	started_at_attribute_idArg, started_at_attribute_idFin := typewrapper.WrapNumberPtr[C.int, int32](started_at_attribute_id)
	ended_at_node_idArg, ended_at_node_idFin := typewrapper.WrapNumberPtr[C.int, int32](ended_at_node_id)
	ended_at_attribute_idArg, ended_at_attribute_idFin := typewrapper.WrapNumberPtr[C.int, int32](ended_at_attribute_id)
	created_from_snapArg, created_from_snapFin := typewrapper.WrapBool[C.bool](created_from_snap)
...
func ImNodesIsLinkDestroyed(link_id *int32) bool {
	link_idArg, link_idFin := typewrapper.WrapNumberPtr[C.int, int32](link_id)
...
func ImNodesIsNodeHovered(node_id *int32) bool {
	node_idArg, node_idFin := typewrapper.WrapNumberPtr[C.int, int32](node_id)
...
func ImNodesLoadCurrentEditorStateFromIniFile(file_name string) {
	file_nameArg, file_nameFin := typewrapper.WrapString[C.char](file_name)
...
func ImNodesPushStyleVarVec2(style_item NodesStyleVar, value cimgui.Vec2) {
...
func ImNodesSetImGuiContext(ctx *cimgui.Context) {
	ctxArg, ctxFin := ctx.handle()
...
func ImNodesSetNodeEditorSpacePos(node_id int32, editor_space_pos cimgui.Vec2) {
	C.imnodes_SetNodeEditorSpacePos(C.int(node_id), editor_space_pos.toC())
}

func ImNodesSetNodeGridSpacePos(node_id int32, grid_pos cimgui.Vec2) {
	C.imnodes_SetNodeGridSpacePos(C.int(node_id), grid_pos.toC())
}

func ImNodesSetNodeScreenSpacePos(node_id int32, screen_space_pos cimgui.Vec2) {
...
func (self NodesStyle) SetNodePadding(v cimgui.Vec2) {
	selfArg, selfFin := self.handle()
	defer selfFin()
...
func (self NodesStyle) SetMiniMapPadding(v cimgui.Vec2) {
	selfArg, selfFin := self.handle()
	defer selfFin()
...
func (self NodesStyle) SetMiniMapOffset(v cimgui.Vec2) {
	selfArg, selfFin := self.handle()
	defer selfFin()
