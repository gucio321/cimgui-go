...
//based on imgui.h file version "1.91.3 WIP" 19121 from Dear ImGui https://github.com/ocornut/imgui
...
CIMGUI_API void igErrorLogCallbackToDebugLog(void* user_data,const char* fmt,...)
{
    va_list args;
    va_start(args, fmt);
    ImGui::ErrorLogCallbackToDebugLogV(user_data,fmt,args);
    va_end(args);
}
