...
//based on imgui.h file version "1.93.0 WIP" 19292 from Dear ImGui https://github.com/ocornut/imgui
...
{
    return self->_SetPixelDensity(pixel_density);
}
...
CIMGUI_API ImVec2_c igImBezierCubicClosestPointCasteljau(const ImVec2_c p1,const ImVec2_c p2,const ImVec2_c p3,const ImVec2_c p4,const ImVec2_c p,float max_error)
{
...
CIMGUI_API void igSetPixelDensity(float pixel_density)
{
    return ImGui::SetPixelDensity(pixel_density);
}
CIMGUI_API float igGetPixelDensity()
{
