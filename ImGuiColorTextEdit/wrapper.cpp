...
void wrap_TextEditor_AddSquiggle(TextEditor* self,DocPos start,DocPos end,size_t type,ImU32 color,const char* tooltip) { TextEditor_AddSquiggle(self,start,end,type,color,std::string_view()); }
