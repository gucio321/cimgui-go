...
void wrap_TextEditor_Render(TextEditor* self,const char* title) { TextEditor_Render(self,title,(ImVec2){},0,ImGuiWindowFlags_NoMove | ImGuiWindowFlags_HorizontalScrollbar); }
