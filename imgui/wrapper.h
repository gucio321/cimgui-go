...
extern bool wrap_igTreeNodeEx_Ptr0(const uintptr_t ptr_id,ImGuiTreeNodeFlags flags,const char* fmt);
...
extern bool wrap_igTreeNode_Ptr0(const uintptr_t ptr_id,const char* fmt);
...
extern int wrap_igGetItemClickedCountWithSingleClickDelay();
...
extern bool wrap_igIsMouseReleasedWithDelay(ImGuiMouseButton button);
...
extern void wrap_igMultiSelectItemFooter(ImGuiID id,bool* p_selected,bool* p_pressed);
extern bool wrap_igOpenPopupEx(ImGuiID id);
extern bool wrap_igOpenPopupOnItemClick();
extern bool wrap_igOpenPopup_ID(ImGuiID id);
extern bool wrap_igOpenPopup_Str(const char* str_id);
